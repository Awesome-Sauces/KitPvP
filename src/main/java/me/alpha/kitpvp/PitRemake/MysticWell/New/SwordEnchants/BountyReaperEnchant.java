...
public class BountyReaperEnchant extends MysticEnchant {

    public BountyReaperEnchant () {
        this.setRefID("bountyreaper");
        this.setTitle("Bounty Reaper");
        this.setLore("&7Deal &c[@lvl@*7]%&7 more damage to bountied players");
