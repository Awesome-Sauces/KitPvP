...
public class BeatTheSpammerEnchant extends MysticEnchant {

    public BeatTheSpammerEnchant () {
        this.setRefID("beatthespammer");
        this.setTitle("Beat the Spammers");
        this.setLore("&7Deal &c+[@lvl@*15]% &7damage vs. players holding a bow");
