...
public class DiamondStompEnchant extends MysticEnchant {

    public DiamondStompEnchant() {
        this.setRefID("diamondstomp");
        this.setTitle("Diamond Stomp");
        this.setLore("&7Deal &c" + "[(@lvl@*8)+1]" + "%&7 damage vs. players " +
