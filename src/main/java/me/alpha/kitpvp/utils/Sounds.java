...
public class Sounds {
    ...
    public static final SoundEffect MYSTIC_WELL_NO = new SoundEffect(Sound.ENDERMAN_HIT, 1, 1);
    ...
    public static final SoundEffect MEGA_RNGESUS = new SoundEffect(Sound.PORTAL_TRIGGER, 1000, .3);
