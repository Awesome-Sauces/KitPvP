...
public class PrestigeBracketColors {


    public static String getBracketColor(Player player){
        String prestige_bracket;
        int current_prestige = ClassInstances.prestigeData.getPrestige(String.valueOf(player.getUniqueId()));
    ...
    public static String getBracketColor(String player){
        String prestige_bracket;
        int current_prestige = ClassInstances.prestigeData.getPrestige(player);
